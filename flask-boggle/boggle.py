...
class Boggle():
    ...
    def __init__(self):
        ...
        self.words = self.read_dict(r"C:\Users\valex\Desktop\Springboard_Assignments\springboard_boggle\flask-boggle\words.txt")

    def read_dict(self, dict_path):
        """Read and return all words in dictionary."""

        with open(dict_path) as file_words:
            all_words = file_words.readlines()
            rest_of_words = [word.strip() for word in all_words]
